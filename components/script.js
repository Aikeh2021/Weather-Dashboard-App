...
function makeCityList(){
    ...
    for(var i = 0; i < cityArray.length; i++){
        ...
        //Making the page change if a city list element is clicked.
        $(".list-group-item").on("click", function(){
          var cityStorageVar = localStorage.getItem("cityFromStorage");
          console.log(cityStorageVar);
          lastCitySearched();
        })
    }
}
